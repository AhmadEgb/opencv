...
static bool ocl_cvtColor(InputArray _src, OutputArray _dst, int code, int dcn)
{
    ...
    {
        int uidx = code == COLOR_YUV2RGBA_NV21 || code == COLOR_YUV2RGB_NV21 || code == COLOR_YUV2BGRA_NV21
    ...
    {
        int uidx = code == COLOR_YUV2BGRA_YV12 || code == COLOR_YUV2BGR_YV12 || code == COLOR_YUV2RGBA_YV12
    ...
    {
        int uidx = code == COLOR_RGBA2YUV_YV12 || code == COLOR_RGB2YUV_YV12 || code == COLOR_BGRA2YUV_YV12
    ...
    {
        int yidx = (code == COLOR_YUV2RGB_UYVY || code == COLOR_YUV2RGBA_UYVY || code == COLOR_YUV2BGR_UYVY
                    || code == COLOR_YUV2BGRA_UYVY)
                       ? 1
                       : 0;
        int uidx = (code == COLOR_YUV2RGB_YVYU || code == COLOR_YUV2RGBA_YVYU || code == COLOR_YUV2BGR_YVYU
                    || code == COLOR_YUV2BGRA_YVYU)
                       ? 2
                       : 0;
        uidx = 1 - yidx + uidx;
...
void cvtColor(InputArray _src, OutputArray _dst, int code, int dcn)
{
    ...
    case COLOR_YUV2BGRA_YVYU:
        ...
        {
            int ycn = (code == COLOR_YUV2RGB_UYVY || code == COLOR_YUV2BGR_UYVY || code == COLOR_YUV2RGBA_UYVY
                       || code == COLOR_YUV2BGRA_UYVY)
                          ? 1
                          : 0;
