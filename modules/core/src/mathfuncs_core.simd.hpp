...
void exp32f(const float* _x, float* y, int n)
{
    ...
    const float A4 = (float)(1.000000000000002438532970795181890933776 / EXPPOLY_32F_A0),
...
void exp64f(const double* _x, double* y, int n)
{
    ...
    const double A5 = .99999999999999999998285227504999 / EXPPOLY_32F_A0,
...
void log64f(const double* x, double* y, int n)
{
    ...
    const double A7 = 1.0, A6 = -0.5, A5 = 0.333333333333333314829616256247390992939472198486328125, A4 = -0.25,
                 A3 = 0.2, A2 = -0.1666666666666666574148081281236954964697360992431640625,
                 A1 = 0.1428571428571428769682682968777953647077083587646484375, A0 = -0.125;
...
#        if CV_SIMD_64F
    ...
    const v_float64 vA0 = vx_setall_f64(A0), vA1 = vx_setall_f64(A1), vA2 = vx_setall_f64(A2),
                    vA3 = vx_setall_f64(A3), vA4 = vx_setall_f64(A4), vA5 = vx_setall_f64(A5),
...
float fastAtan2(float y, float x) { return atan_f32(y, x); }
