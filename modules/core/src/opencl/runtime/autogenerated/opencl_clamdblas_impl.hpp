...
#define openclamdblas_fn0(ID, _R, decl_args) \
    ...
    static _R ID##_switch_fn decl_args { return ((ID##FN)openclamdblas_check_fn(ID))(); }

#define openclamdblas_fn1(ID, _R, decl_args) \
    typedef _R(*ID##FN) decl_args; \
    static _R ID##_switch_fn decl_args { return ((ID##FN)openclamdblas_check_fn(ID))(p1); }

#define openclamdblas_fn2(ID, _R, decl_args) \
    typedef _R(*ID##FN) decl_args; \
    static _R ID##_switch_fn decl_args { return ((ID##FN)openclamdblas_check_fn(ID))(p1, p2); }

#define openclamdblas_fn3(ID, _R, decl_args) \
    typedef _R(*ID##FN) decl_args; \
    static _R ID##_switch_fn decl_args { return ((ID##FN)openclamdblas_check_fn(ID))(p1, p2, p3); }

#define openclamdblas_fn4(ID, _R, decl_args) \
    typedef _R(*ID##FN) decl_args; \
    static _R ID##_switch_fn decl_args { return ((ID##FN)openclamdblas_check_fn(ID))(p1, p2, p3, p4); }

#define openclamdblas_fn5(ID, _R, decl_args) \
    typedef _R(*ID##FN) decl_args; \
    static _R ID##_switch_fn decl_args { return ((ID##FN)openclamdblas_check_fn(ID))(p1, p2, p3, p4, p5); }

#define openclamdblas_fn6(ID, _R, decl_args) \
    typedef _R(*ID##FN) decl_args; \
    static _R ID##_switch_fn decl_args { return ((ID##FN)openclamdblas_check_fn(ID))(p1, p2, p3, p4, p5, p6); }

#define openclamdblas_fn7(ID, _R, decl_args) \
    typedef _R(*ID##FN) decl_args; \
    static _R ID##_switch_fn decl_args { return ((ID##FN)openclamdblas_check_fn(ID))(p1, p2, p3, p4, p5, p6, p7); }
...
openclamdblas_fn22(OPENCLAMDBLAS_FN_clAmdBlasCgemmEx, clAmdBlasStatus,
                   (clAmdBlasOrder p1, clAmdBlasTranspose p2, clAmdBlasTranspose p3, size_t p4, size_t p5,
                    size_t p6, FloatComplex p7, const cl_mem p8, size_t p9, size_t p10, const cl_mem p11,
                    size_t p12, size_t p13, FloatComplex p14, cl_mem p15, size_t p16, size_t p17, cl_uint p18,
                    cl_command_queue* p19, cl_uint p20, const cl_event* p21, cl_event* p22))
    clAmdBlasStatus (*clAmdBlasCgemmEx)(clAmdBlasOrder, clAmdBlasTranspose, clAmdBlasTranspose, size_t, size_t,
                                        size_t, FloatComplex, const cl_mem, size_t, size_t, const cl_mem, size_t,
                                        size_t, FloatComplex, cl_mem, size_t, size_t, cl_uint, cl_command_queue*,
                                        cl_uint, const cl_event*,
                                        cl_event*) = OPENCLAMDBLAS_FN_clAmdBlasCgemmEx_switch_fn;
...
openclamdblas_fn22(OPENCLAMDBLAS_FN_clAmdBlasDgemmEx, clAmdBlasStatus,
                   (clAmdBlasOrder p1, clAmdBlasTranspose p2, clAmdBlasTranspose p3, size_t p4, size_t p5,
                    size_t p6, cl_double p7, const cl_mem p8, size_t p9, size_t p10, const cl_mem p11, size_t p12,
                    size_t p13, cl_double p14, cl_mem p15, size_t p16, size_t p17, cl_uint p18,
                    cl_command_queue* p19, cl_uint p20, const cl_event* p21, cl_event* p22))
    clAmdBlasStatus (*clAmdBlasDgemmEx)(clAmdBlasOrder, clAmdBlasTranspose, clAmdBlasTranspose, size_t, size_t,
                                        size_t, cl_double, const cl_mem, size_t, size_t, const cl_mem, size_t,
                                        size_t, cl_double, cl_mem, size_t, size_t, cl_uint, cl_command_queue*,
                                        cl_uint, const cl_event*,
                                        cl_event*) = OPENCLAMDBLAS_FN_clAmdBlasDgemmEx_switch_fn;
...
openclamdblas_fn0(OPENCLAMDBLAS_FN_clAmdBlasSetup, clAmdBlasStatus, ())
    clAmdBlasStatus (*clAmdBlasSetup)() = OPENCLAMDBLAS_FN_clAmdBlasSetup_switch_fn;
...
openclamdblas_fn22(OPENCLAMDBLAS_FN_clAmdBlasSgemmEx, clAmdBlasStatus,
                   (clAmdBlasOrder p1, clAmdBlasTranspose p2, clAmdBlasTranspose p3, size_t p4, size_t p5,
                    size_t p6, cl_float p7, const cl_mem p8, size_t p9, size_t p10, const cl_mem p11, size_t p12,
                    size_t p13, cl_float p14, cl_mem p15, size_t p16, size_t p17, cl_uint p18,
                    cl_command_queue* p19, cl_uint p20, const cl_event* p21, cl_event* p22))
    clAmdBlasStatus (*clAmdBlasSgemmEx)(clAmdBlasOrder, clAmdBlasTranspose, clAmdBlasTranspose, size_t, size_t,
                                        size_t, cl_float, const cl_mem, size_t, size_t, const cl_mem, size_t, size_t,
                                        cl_float, cl_mem, size_t, size_t, cl_uint, cl_command_queue*, cl_uint,
                                        const cl_event*, cl_event*) = OPENCLAMDBLAS_FN_clAmdBlasSgemmEx_switch_fn;
...
openclamdblas_fn0(OPENCLAMDBLAS_FN_clAmdBlasTeardown, void,
                  ()) void (*clAmdBlasTeardown)() = OPENCLAMDBLAS_FN_clAmdBlasTeardown_switch_fn;
...
openclamdblas_fn22(OPENCLAMDBLAS_FN_clAmdBlasZgemmEx, clAmdBlasStatus,
                   (clAmdBlasOrder p1, clAmdBlasTranspose p2, clAmdBlasTranspose p3, size_t p4, size_t p5,
                    size_t p6, DoubleComplex p7, const cl_mem p8, size_t p9, size_t p10, const cl_mem p11,
                    size_t p12, size_t p13, DoubleComplex p14, cl_mem p15, size_t p16, size_t p17, cl_uint p18,
                    cl_command_queue* p19, cl_uint p20, const cl_event* p21, cl_event* p22))
    clAmdBlasStatus (*clAmdBlasZgemmEx)(clAmdBlasOrder, clAmdBlasTranspose, clAmdBlasTranspose, size_t, size_t,
                                        size_t, DoubleComplex, const cl_mem, size_t, size_t, const cl_mem, size_t,
                                        size_t, DoubleComplex, cl_mem, size_t, size_t, cl_uint, cl_command_queue*,
                                        cl_uint, const cl_event*,
                                        cl_event*) = OPENCLAMDBLAS_FN_clAmdBlasZgemmEx_switch_fn;
