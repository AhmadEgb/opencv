...
void cv::hconcat(const Mat* src, size_t nsrc, OutputArray _dst)
{
    ...
    {
        CV_Assert(src[i].dims <= 2 && src[i].rows == src[0].rows && src[i].type() == src[0].type());
...
void cv::vconcat(const Mat* src, size_t nsrc, OutputArray _dst)
{
    ...
    for (size_t i = 0; i < nsrc; i++)
    {
        CV_Assert(src[i].dims <= 2 && src[i].cols == src[0].cols && src[i].type() == src[0].type());
...
static bool ocl_setIdentity(InputOutputArray _m, const Scalar& s)
{
    ...
    ocl::Kernel k("setIdentity", ocl::core::set_identity_oclsrc,
                  format("-D T=%s -D T1=%s -D cn=%d -D ST=%s -D kercn=%d -D rowsPerWI=%d",
                         ocl::memopTypeToStr(CV_MAKE_TYPE(depth, kercn)), ocl::memopTypeToStr(depth), cn,
                         ocl::memopTypeToStr(sctype), kercn, rowsPerWI));
    if (k.empty())
        return false;

    UMat m = _m.getUMat();
    k.args(ocl::KernelArg::WriteOnly(m, cn, kercn), ocl::KernelArg::Constant(Mat(1, 1, sctype, s)));
...
void cv::setIdentity(InputOutputArray _m, const Scalar& s)
{
    ...
    CV_OCL_RUN(_m.isUMat(), ocl_setIdentity(_m, s))
...
template<typename T>
static void transpose_(const uchar* src, size_t sstep, uchar* dst, size_t dstep, Size sz)
{
...
template<typename T>
static void transposeI_(uchar* data, size_t step, int n)
{
    for (int i = 0; i < n; i++)
    {
        T* row = (T*)(data + step * i);
...
\
    static void transposeI_##suffix(uchar* data, size_t step, int n) { transposeI_<type>(data, step, n); }
...
static bool ocl_transpose(InputArray _src, OutputArray _dst)
{
    ...
    int type = _src.type(), cn = CV_MAT_CN(type), depth = CV_MAT_DEPTH(type), rowsPerWI = dev.isIntel() ? 4 : 1;
    ...
    ocl::Kernel k(kernelName.c_str(), ocl::core::transpose_oclsrc,
                  format("-D T=%s -D T1=%s -D cn=%d -D TILE_DIM=%d -D BLOCK_ROWS=%d -D rowsPerWI=%d%s",
                         ocl::memopTypeToStr(type), ocl::memopTypeToStr(depth), cn, TILE_DIM, BLOCK_ROWS,
                         rowsPerWI, inplace ? " -D INPLACE" : ""));
    if (k.empty())
        return false;
    ...
    if (inplace)
        ...
        k.args(ocl::KernelArg::ReadOnly(src), ocl::KernelArg::WriteOnlyNoSize(dst));

    size_t localsize[2] = {TILE_DIM, BLOCK_ROWS};
    size_t globalsize[2] = {(size_t)src.cols, inplace ? ((size_t)src.rows + rowsPerWI - 1) / rowsPerWI
                                                      : (divUp((size_t)src.rows, TILE_DIM) * BLOCK_ROWS)};
...
static bool ipp_transpose(Mat& src, Mat& dst)
{
    ...
    int type = src.type();
    typedef IppStatus(CV_STDCALL * IppiTranspose)(const void* pSrc, int srcStep, void* pDst, int dstStep,
                                                  IppiSize roiSize);
    ...
    if (dst.data == src.data && dst.cols == dst.rows)
    {
        ...
        ippiTranspose_I =
            type == CV_8UC1
                ? (IppiTransposeI)ippiTranspose_8u_C1IR
                : type == CV_8UC3
                      ? (IppiTransposeI)ippiTranspose_8u_C3IR
                      : type == CV_8UC4
                            ? (IppiTransposeI)ippiTranspose_8u_C4IR
                            : type == CV_16UC1
                                  ? (IppiTransposeI)ippiTranspose_16u_C1IR
                                  : type == CV_16UC3
                                        ? (IppiTransposeI)ippiTranspose_16u_C3IR
                                        : type == CV_16UC4
                                              ? (IppiTransposeI)ippiTranspose_16u_C4IR
                                              : type == CV_16SC1
                                                    ? (IppiTransposeI)ippiTranspose_16s_C1IR
                                                    : type == CV_16SC3
                                                          ? (IppiTransposeI)ippiTranspose_16s_C3IR
                                                          : type == CV_16SC4
                                                                ? (IppiTransposeI)ippiTranspose_16s_C4IR
                                                                : type == CV_32SC1
                                                                      ? (IppiTransposeI)ippiTranspose_32s_C1IR
                                                                      : type == CV_32SC3
                                                                            ? (IppiTransposeI)ippiTranspose_32s_C3IR
                                                                            : type == CV_32SC4
                                                                                  ? (IppiTransposeI)ippiTranspose_32s_C4IR
                                                                                  : type == CV_32FC1
                                                                                        ? (IppiTransposeI)ippiTranspose_32f_C1IR
                                                                                        : type == CV_32FC3
                                                                                              ? (IppiTransposeI)ippiTranspose_32f_C3IR
                                                                                              : type == CV_32FC4
                                                                                                    ? (IppiTransposeI)ippiTranspose_32f_C4IR
                                                                                                    : 0;
    ...
    else
    {
        ippiTranspose =
            type == CV_8UC1
                ? (IppiTranspose)ippiTranspose_8u_C1R
                : type == CV_8UC3
                      ? (IppiTranspose)ippiTranspose_8u_C3R
                      : type == CV_8UC4
                            ? (IppiTranspose)ippiTranspose_8u_C4R
                            : type == CV_16UC1
                                  ? (IppiTranspose)ippiTranspose_16u_C1R
                                  : type == CV_16UC3
                                        ? (IppiTranspose)ippiTranspose_16u_C3R
                                        : type == CV_16UC4
                                              ? (IppiTranspose)ippiTranspose_16u_C4R
                                              : type == CV_16SC1
                                                    ? (IppiTranspose)ippiTranspose_16s_C1R
                                                    : type == CV_16SC3
                                                          ? (IppiTranspose)ippiTranspose_16s_C3R
                                                          : type == CV_16SC4
                                                                ? (IppiTranspose)ippiTranspose_16s_C4R
                                                                : type == CV_32SC1
                                                                      ? (IppiTranspose)ippiTranspose_32s_C1R
                                                                      : type == CV_32SC3
                                                                            ? (IppiTranspose)ippiTranspose_32s_C3R
                                                                            : type == CV_32SC4
                                                                                  ? (IppiTranspose)ippiTranspose_32s_C4R
                                                                                  : type == CV_32FC1
                                                                                        ? (IppiTranspose)ippiTranspose_32f_C1R
                                                                                        : type == CV_32FC3
                                                                                              ? (IppiTranspose)ippiTranspose_32f_C3R
                                                                                              : type == CV_32FC4
                                                                                                    ? (IppiTranspose)ippiTranspose_32f_C4R
                                                                                                    : 0;
    }
...
void cv::transpose(InputArray _src, OutputArray _dst)
{
    ...
    CV_OCL_RUN(_dst.isUMat(), ocl_transpose(_src, _dst))
...
template<typename T, typename ST, class Op>
static void reduceR_(const Mat& srcmat, Mat& dstmat)
{
...
template<typename T, typename ST, class Op>
static void reduceC_(const Mat& srcmat, Mat& dstmat)
{
    typedef typename Op::rtype WT;
    Size size = srcmat.size();
...
{
    int sstep = (int)srcmat.step, stype = srcmat.type(), ddepth = dstmat.depth();
    ...
    typedef IppStatus(CV_STDCALL * IppiSumHint)(const void* pSrc, int srcStep, IppiSize roiSize, Ipp64f* pSum,
    ...
    if (ddepth == CV_64F)
    {
        ippiSum = stype == CV_8UC1
                      ? (IppiSum)ippiSum_8u_C1R
                      : stype == CV_8UC3
                            ? (IppiSum)ippiSum_8u_C3R
                            : stype == CV_8UC4
                                  ? (IppiSum)ippiSum_8u_C4R
                                  : stype == CV_16UC1
                                        ? (IppiSum)ippiSum_16u_C1R
                                        : stype == CV_16UC3
                                              ? (IppiSum)ippiSum_16u_C3R
                                              : stype == CV_16UC4
                                                    ? (IppiSum)ippiSum_16u_C4R
                                                    : stype == CV_16SC1
                                                          ? (IppiSum)ippiSum_16s_C1R
                                                          : stype == CV_16SC3
                                                                ? (IppiSum)ippiSum_16s_C3R
                                                                : stype == CV_16SC4 ? (IppiSum)ippiSum_16s_C4R : 0;
        ippiSumHint = stype == CV_32FC1 ? (IppiSumHint)ippiSum_32f_C1R
    ...
    else if (ippiSumHint)
    {
        for (int y = 0; y < srcmat.size().height; y++)
        {
            if (CV_INSTRUMENT_FUN_IPP(ippiSumHint, srcmat.ptr(y), sstep, roisize, dstmat.ptr<Ipp64f>(y),
                                      ippAlgHintAccurate)
                < 0)
                return false;
        }
...
static inline void reduceSumC_8u16u16s32f_64f(const cv::Mat& srcmat, cv::Mat& dstmat)
{
    ...
    if (dstmat.depth() == CV_64F)
    {
        ...
        func = sdepth == CV_8U
                   ? (cv::ReduceFunc)cv::reduceC_<uchar, double, cv::OpAdd<double>>
                   : sdepth == CV_16U
                         ? (cv::ReduceFunc)cv::reduceC_<ushort, double, cv::OpAdd<double>>
                         : sdepth == CV_16S
                               ? (cv::ReduceFunc)cv::reduceC_<short, double, cv::OpAdd<double>>
                               : sdepth == CV_32F ? (cv::ReduceFunc)cv::reduceC_<float, double, cv::OpAdd<double>>
                                                  : 0;
    }
    CV_Assert(func);
...
#    define REDUCE_OP(favor, optype, type1, type2) \
        ...
        { \
            ...
            { \
                ...
                for (int y = 0; y < srcmat.size().height; y++) \
                { \
                    if (CV_INSTRUMENT_FUN_IPP(ippi##optype##_##favor##_C1R, srcmat.ptr<IppType>(y), sstep, \
                                              roisize, dstmat.ptr<IppType>(y)) \
                        < 0) \
                        return false; \
                } \
                return true; \
...
static bool ocl_reduce(InputArray _src, OutputArray _dst, int dim, int op, int op0, int stype, int dtype)
{
    const int min_opt_cols = 128, buf_cols = 32;
    int sdepth = CV_MAT_DEPTH(stype), cn = CV_MAT_CN(stype), ddepth = CV_MAT_DEPTH(dtype), ddepth0 = ddepth;
    ...
    const char* const ops[4] = {"OCL_CV_REDUCE_SUM", "OCL_CV_REDUCE_AVG", "OCL_CV_REDUCE_MAX", "OCL_CV_REDUCE_MIN"};
    ...
    if (useOptimized)
    {
        ...
        if (defDev.isIntel())
        {
            ...
            tileHeight = min(tileHeight, defDev.localMemSize() / buf_cols / CV_ELEM_SIZE(CV_MAKETYPE(wdepth, cn))
                                             / maxItemInGroupCount);
        }
        char cvt[3][40];
        cv::String build_opt = format("-D OP_REDUCE_PRE -D BUF_COLS=%d -D TILE_HEIGHT=%zu -D %s -D dim=1"
                                      ...
                                      buf_cols, tileHeight, ops[op], cn, ddepth, ocl::typeToStr(sdepth),
        ...
        if (op0 == CV_REDUCE_AVG)
            k.args(ocl::KernelArg::ReadOnly(src), ocl::KernelArg::WriteOnlyNoSize(dst), 1.0f / src.cols);
        else
            k.args(ocl::KernelArg::ReadOnly(src), ocl::KernelArg::WriteOnlyNoSize(dst));
    ...
    else
    {
        ...
        ocl::KernelArg srcarg = ocl::KernelArg::ReadOnly(src), temparg = ocl::KernelArg::WriteOnlyNoSize(dst);
...
void cv::reduce(InputArray _src, OutputArray _dst, int dim, int op, int dtype)
{
    ...
    CV_Assert(op == CV_REDUCE_SUM || op == CV_REDUCE_MAX || op == CV_REDUCE_MIN || op == CV_REDUCE_AVG);

    CV_OCL_RUN(_dst.isUMat(), ocl_reduce(_src, _dst, dim, op, op0, stype, dtype))
...
template<typename T>
static void sort_(const Mat& src, Mat& dst, int flags)
{
    AutoBuffer<T> buf;
    int n, len;
...
static IppSortFunc getSortFunc(int depth, bool sortDescending)
{
    if (!sortDescending)
        return depth == CV_8U
                   ? (IppSortFunc)ippsSortRadixAscend_8u_I
                   : depth == CV_16U
                         ? (IppSortFunc)ippsSortRadixAscend_16u_I
                         : depth == CV_16S
                               ? (IppSortFunc)ippsSortRadixAscend_16s_I
                               : depth == CV_32S
                                     ? (IppSortFunc)ippsSortRadixAscend_32s_I
                                     : depth == CV_32F
                                           ? (IppSortFunc)ippsSortRadixAscend_32f_I
                                           : depth == CV_64F ? (IppSortFunc)ippsSortRadixAscend_64f_I : 0;
    else
        return depth == CV_8U
                   ? (IppSortFunc)ippsSortRadixDescend_8u_I
                   : depth == CV_16U
                         ? (IppSortFunc)ippsSortRadixDescend_16u_I
                         : depth == CV_16S
                               ? (IppSortFunc)ippsSortRadixDescend_16s_I
                               : depth == CV_32S
                                     ? (IppSortFunc)ippsSortRadixDescend_32s_I
                                     : depth == CV_32F
                                           ? (IppSortFunc)ippsSortRadixDescend_32f_I
                                           : depth == CV_64F ? (IppSortFunc)ippsSortRadixDescend_64f_I : 0;
}
...
template<typename T>
static void sortIdx_(const Mat& src, Mat& dst, int flags)
{
    AutoBuffer<T> buf;
    AutoBuffer<int> ibuf;
    bool sortRows = (flags & 1) == CV_SORT_EVERY_ROW;
...
#ifdef HAVE_IPP
typedef IppStatus(CV_STDCALL* IppSortIndexFunc)(const void* pSrc, Ipp32s srcStrideBytes, Ipp32s* pDstIndx, int len,
                                                Ipp8u* pBuffer);
...
static IppSortIndexFunc getSortIndexFunc(int depth, bool sortDescending)
{
    if (!sortDescending)
        return depth == CV_8U
                   ? (IppSortIndexFunc)ippsSortRadixIndexAscend_8u
                   : depth == CV_16U
                         ? (IppSortIndexFunc)ippsSortRadixIndexAscend_16u
                         : depth == CV_16S
                               ? (IppSortIndexFunc)ippsSortRadixIndexAscend_16s
                               : depth == CV_32S
                                     ? (IppSortIndexFunc)ippsSortRadixIndexAscend_32s
                                     : depth == CV_32F ? (IppSortIndexFunc)ippsSortRadixIndexAscend_32f : 0;
    else
        return depth == CV_8U
                   ? (IppSortIndexFunc)ippsSortRadixIndexDescend_8u
                   : depth == CV_16U
                         ? (IppSortIndexFunc)ippsSortRadixIndexDescend_16u
                         : depth == CV_16S
                               ? (IppSortIndexFunc)ippsSortRadixIndexDescend_16s
                               : depth == CV_32S
                                     ? (IppSortIndexFunc)ippsSortRadixIndexDescend_32s
                                     : depth == CV_32F ? (IppSortIndexFunc)ippsSortRadixIndexDescend_32f : 0;
}
...
static bool ipp_sortIdx(const Mat& src, Mat& dst, int flags)
{
    ...
    if (sortRows)
    {
        ...
        {
            if (CV_INSTRUMENT_FUN_IPP(ippsSortRadixIndex, (const void*)src.ptr(i), (Ipp32s)src.step[1],
                                      (Ipp32s*)dst.ptr(i), src.cols, buffer.data())
                < 0)
                return false;
        }
    }
    else
    {
        ...
        for (int i = 0; i < src.cols; i++)
        {
            ...
            if (CV_INSTRUMENT_FUN_IPP(ippsSortRadixIndex, (const void*)src.ptr(0, i), srcStep,
                                      (Ipp32s*)dstRow.ptr(), src.rows, buffer.data())
                < 0)
                return false;
...
void cv::sort(InputArray _src, OutputArray _dst, int flags)
{
    ...
    static SortFunc tab[] = {sort_<uchar>, sort_<schar>, sort_<ushort>, sort_<short>,
...
void cv::sortIdx(InputArray _src, OutputArray _dst, int flags)
{
    ...
    static SortFunc tab[] = {sortIdx_<uchar>, sortIdx_<schar>, sortIdx_<ushort>, sortIdx_<short>,
