...
static char* icvJSONSkipSpaces(CvFileStorage* fs, char* ptr)
{
    bool is_eof = false;
        ...
        { /**************** normal string ****************/
            ...
            while (!is_matching)
            {
                ...
                case '\\':
                {
                    ...
                    case '\'':
                    {
                        string_buffer.append(1u, *ptr);
                        break;
                    }
                    case 'n':
                    {
                        string_buffer.append(1u, '\n');
                        break;
                    }
                    case 'r':
                    {
                        string_buffer.append(1u, '\r');
                        break;
                    }
                    case 't':
                    {
                    ...
                    case 'b':
                    {
                        string_buffer.append(1u, '\b');
                        break;
                    }
                    case 'f':
                    {
                        string_buffer.append(1u, '\f');
                        break;
                    }
                    case 'u':
                    {
                        CV_PARSE_ERROR("'\\uXXXX' currently not supported");
                    }
                    default:
                    {
                        CV_PARSE_ERROR("Invalid escape character");
                    }
                    break;
                    }
                    ptr++;
            ...
            node->data.str = cvMemStorageAllocString(fs->memstorage, string_buffer.c_str(),
