...
namespace cv { namespace utils { namespace trace {
...
#define CV__TRACE_DEFINE_LOCATION_(loc_id, name, flags) \
    ...
    static const CV_TRACE_NS::details::Region::LocationStaticStorage CV__TRACE_LOCATION_VARNAME( \
        loc_id) = {&(CV__TRACE_LOCATION_EXTRA_VARNAME(loc_id)), name, CV_TRACE_FILENAME, __LINE__, flags};
