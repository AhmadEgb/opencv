...
#define OPENCV_HAL_IMPL_VSX_LOADSTORE_C(_Tpvec, _Tp, ld, ld_a, st, st_a) \
    ...
    inline _Tpvec v_load_aligned(VSX_UNUSED(const _Tp* ptr)) { return _Tpvec(ld_a(0, ptr)); } \
    ...
    inline void v_store_aligned(VSX_UNUSED(_Tp* ptr), const _Tpvec& a) { st_a(a.val, 0, ptr); } \
    inline void v_store_aligned_nocache(VSX_UNUSED(_Tp* ptr), const _Tpvec& a) { st_a(a.val, 0, ptr); } \
    ...
    inline void v_store_low(_Tp* ptr, const _Tpvec& a) { vec_st_l8(a.val, ptr); } \
...
#define OPENCV_HAL_IMPL_VSX_EXPAND(_Tpvec, _Tpwvec, _Tp, fl, fh) \
    ...
    inline _Tpwvec v_load_expand(const _Tp* ptr) { return _Tpwvec(fh(vec_ld_l8(ptr))); }
...
#define OPENCV_HAL_IMPL_VSX_PACK(_Tpvec, _Tp, _Tpwvec, _Tpvn, _Tpdel, sfnc, pkfnc, addfnc, pack) \
    inline _Tpvec v_##pack(const _Tpwvec& a, const _Tpwvec& b) { return _Tpvec(pkfnc(a.val, b.val)); } \
    inline void v_##pack##_store(_Tp* ptr, const _Tpwvec& a) { vec_st_l8(pkfnc(a.val, a.val), ptr); } \
    template<int n> \
...
OPENCV_HAL_IMPL_VSX_PACK(v_uint8x16, uchar, v_uint16x8, unsigned short, unsigned short, vec_sr, vec_packs,
                         vec_adds, pack)
OPENCV_HAL_IMPL_VSX_PACK(v_int8x16, schar, v_int16x8, unsigned short, short, vec_sra, vec_packs, vec_adds, pack)

OPENCV_HAL_IMPL_VSX_PACK(v_uint16x8, ushort, v_uint32x4, unsigned int, unsigned int, vec_sr, vec_packs, vec_add, pack)
...
{
    return v_int16x8(vec_packs(vec_sra(vec_mul(vec_unpackh(a.val), vec_unpackh(b.val)), vec_uint4_sp(16)),
                               vec_sra(vec_mul(vec_unpackl(a.val), vec_unpackl(b.val)), vec_uint4_sp(16))));
}
inline v_uint16x8 v_mul_hi(const v_uint16x8& a, const v_uint16x8& b)
{
    return v_uint16x8(vec_packs(vec_sr(vec_mul(vec_unpackhu(a.val), vec_unpackhu(b.val)), vec_uint4_sp(16)),
...
#define OPENCV_HAL_IMPL_VSX_SHIFT_OP(_Tpvec, shr, splfunc) \
    inline _Tpvec operator<<(const _Tpvec& a, int imm) { return _Tpvec(vec_sl(a.val, splfunc(imm))); } \
    inline _Tpvec operator>>(const _Tpvec& a, int imm) { return _Tpvec(shr(a.val, splfunc(imm))); } \
    template<int imm> \
...
#define OPENCV_HAL_IMPL_VSX_LOGIC_OP(_Tpvec) \
    ...
    inline _Tpvec operator~(const _Tpvec& a) { return _Tpvec(vec_not(a.val)); }
...
#define OPENCV_HAL_IMPL_VSX_INT_CMP_OP(_Tpvec) \
    inline _Tpvec operator==(const _Tpvec& a, const _Tpvec& b) { return _Tpvec(vec_cmpeq(a.val, b.val)); } \
    inline _Tpvec operator!=(const _Tpvec& a, const _Tpvec& b) { return _Tpvec(vec_cmpne(a.val, b.val)); } \
    inline _Tpvec operator<(const _Tpvec& a, const _Tpvec& b) { return _Tpvec(vec_cmplt(a.val, b.val)); } \
    inline _Tpvec operator>(const _Tpvec& a, const _Tpvec& b) { return _Tpvec(vec_cmpgt(a.val, b.val)); } \
    inline _Tpvec operator<=(const _Tpvec& a, const _Tpvec& b) { return _Tpvec(vec_cmple(a.val, b.val)); } \
    inline _Tpvec operator>=(const _Tpvec& a, const _Tpvec& b) { return _Tpvec(vec_cmpge(a.val, b.val)); }
...
inline v_int32x4 v_muladd(const v_int32x4& a, const v_int32x4& b, const v_int32x4& c) { return a * b + c; }
...
#define OPENCV_HAL_IMPL_VSX_BIN_FUNC2(_Tpvec, _Tpvec2, cast, func, intrin) \
    inline _Tpvec2 func(const _Tpvec& a, const _Tpvec& b) { return _Tpvec2(cast(intrin(a.val, b.val))); }
...
inline v_int32x4 v_trunc(const v_float64x2& a) { return v_int32x4(vec_mergesqo(vec_ctso(a.val), vec_int4_z)); }
...
inline v_float64x2 v_cvt_f64(const v_int32x4& a) { return v_float64x2(vec_ctdo(vec_mergeh(a.val, a.val))); }

inline v_float64x2 v_cvt_f64_high(const v_int32x4& a) { return v_float64x2(vec_ctdo(vec_mergel(a.val, a.val))); }

inline v_float64x2 v_cvt_f64(const v_float32x4& a) { return v_float64x2(vec_cvfo(vec_mergeh(a.val, a.val))); }

inline v_float64x2 v_cvt_f64_high(const v_float32x4& a) { return v_float64x2(vec_cvfo(vec_mergel(a.val, a.val))); }
