...
inline cl_command_queue clCreateCommandQueue(cl_context p0, cl_device_id p1, cl_command_queue_properties p2,
                                             cl_int* p3)
{
...
inline cl_program clCreateProgramWithBuiltInKernels(cl_context p0, cl_uint p1, const cl_device_id* p2,
...
inline cl_int clCreateSubDevices(cl_device_id p0, const cl_device_partition_property* p1, cl_uint p2,
...
inline cl_int clEnqueueCopyBufferRect(cl_command_queue p0, cl_mem p1, cl_mem p2, const size_t* p3,
                                      const size_t* p4, const size_t* p5, size_t p6, size_t p7, size_t p8,
                                      size_t p9, cl_uint p10, const cl_event* p11, cl_event* p12)
{
...
inline cl_int clEnqueueCopyImageToBuffer(cl_command_queue p0, cl_mem p1, cl_mem p2, const size_t* p3,
                                         const size_t* p4, size_t p5, cl_uint p6, const cl_event* p7, cl_event* p8)
{
...
inline cl_int clEnqueueFillImage(cl_command_queue p0, cl_mem p1, const void* p2, const size_t* p3,
...
inline cl_int clEnqueueMigrateMemObjects(cl_command_queue p0, cl_uint p1, const cl_mem* p2,
                                         cl_mem_migration_flags p3, cl_uint p4, const cl_event* p5, cl_event* p6)
{
    return clEnqueueMigrateMemObjects_pfn(p0, p1, p2, p3, p4, p5, p6);
}
#undef clEnqueueNDRangeKernel
#define clEnqueueNDRangeKernel clEnqueueNDRangeKernel_fn
inline cl_int clEnqueueNDRangeKernel(cl_command_queue p0, cl_kernel p1, cl_uint p2, const size_t* p3,
                                     const size_t* p4, const size_t* p5, cl_uint p6, const cl_event* p7,
                                     cl_event* p8)
{
...
inline cl_int clEnqueueNativeKernel(cl_command_queue p0, void(CL_CALLBACK* p1)(void*), void* p2, size_t p3,
                                    cl_uint p4, const cl_mem* p5, const void** p6, cl_uint p7, const cl_event* p8,
                                    cl_event* p9)
{
...
inline cl_int clEnqueueReadBufferRect(cl_command_queue p0, cl_mem p1, cl_bool p2, const size_t* p3,
                                      const size_t* p4, const size_t* p5, size_t p6, size_t p7, size_t p8,
                                      size_t p9, void* p10, cl_uint p11, const cl_event* p12, cl_event* p13)
{
...
inline cl_int clEnqueueWriteBuffer(cl_command_queue p0, cl_mem p1, cl_bool p2, size_t p3, size_t p4,
...
inline cl_int clEnqueueWriteBufferRect(cl_command_queue p0, cl_mem p1, cl_bool p2, const size_t* p3,
                                       const size_t* p4, const size_t* p5, size_t p6, size_t p7, size_t p8,
                                       size_t p9, const void* p10, cl_uint p11, const cl_event* p12, cl_event* p13)
{
...
inline cl_int clGetKernelWorkGroupInfo(cl_kernel p0, cl_device_id p1, cl_kernel_work_group_info p2, size_t p3,
                                       void* p4, size_t* p5)
{
