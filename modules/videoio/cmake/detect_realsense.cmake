...
if(NOT HAVE_LIBREALSENSE)
  ...
  if(realsense2_FOUND)
    ...
    add_3p_target(librealsense "" "${realsense2_LIBRARY}" "HAVE_LIBREALSENSE")
  endif()
endif()
...
if(NOT HAVE_LIBREALSENSE)
  ...
  if(LIBREALSENSE_INCLUDE_DIR AND LIBREALSENSE_LIBRARIES)
    ...
    add_3p_target(librealsense "${LIBREALSENSE_INCLUDE_DIR}" "${LIBREALSENSE_LIBRARIES}" "HAVE_LIBREALSENSE")
  endif()
endif()
