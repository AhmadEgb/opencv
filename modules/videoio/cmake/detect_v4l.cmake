...
if(NOT HAVE_V4L)
  ...
  if(HAVE_CAMV4L2 OR HAVE_VIDEOIO)
    set(HAVE_V4L TRUE)
    add_library(ocv.3rdparty.v4l INTERFACE)
    if(HAVE_CAMV4L2)
    ...
    export(TARGETS ocv.3rdparty.v4l APPEND FILE "${CMAKE_BINARY_DIR}/OpenCVModules.cmake")
    install(TARGETS ocv.3rdparty.v4l EXPORT OpenCVModules)
  endif()
endif()
