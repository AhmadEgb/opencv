...
public:
    ...
    int addNodeToMatch(const std::string& op, int input_0 = -1, int input_1 = -1, int input_2 = -1, int input_3 = -1)
    {
    ...
    // TODO: Replace inputs to std::vector<int> in C++11
    void setFusedNode(const std::string& op, int input_0 = -1, int input_1 = -1, int input_2 = -1,
                      int input_3 = -1, int input_4 = -1, int input_5 = -1)
    {
    ...
    static const tensorflow::NodeDef& getInputNode(const tensorflow::GraphDef& net,
                                                   const tensorflow::NodeDef& node, int inpId)
    {
    ...
    virtual void finalize(tensorflow::GraphDef&, tensorflow::NodeDef*, std::vector<tensorflow::NodeDef*>&) {}
...
public:
                          ...
                          std::vector<tensorflow::NodeDef*>& inputNodes) CV_OVERRIDE
    {
        ...
        CV_CheckEQ(factorsMat.total(), (size_t)2, "");
        CV_CheckTypeEQ(factorsMat.type(), CV_32SC1, "");
...
static void permute(google::protobuf::RepeatedPtrField<tensorflow::NodeDef>* data, const std::vector<int>& indices)
{
